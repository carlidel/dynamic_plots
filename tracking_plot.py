...
def test_track(xmin, xmax, ymin, ymax, epsilon=0.0, mu=0.0, th1=0.0, th2=0.0, n_turns=10000, err=None, special_view=None):
    sampling = 300   # SAMPLING FOR THE GIVEN VIEW
    limit = n_turns    # MAXIMUM NUMBER OF TURNS
    ...
    _, _, _, _, data = engine.compute(limit, epsilon, mu)
...
if __name__ == "__main__":
    ...
    ax.set_title("Simple tracking of particles")
